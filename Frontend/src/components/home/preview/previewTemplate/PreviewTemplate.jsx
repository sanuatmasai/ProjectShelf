...
const sampleData = {
  ...
  bio: "I have built many industry grade projects from scratch and am armed with many technological skills useful for tech projects. Check out my projects below.",
  mobileNumber: "7091512373",
  profilePicUrl:
    "https://ecomm-dev-public.s3.ap-south-1.amazonaws.com/uploads/1709112233230.jpg",
  linkedinUrl: "https://www.linkedin.com/in/kumarsanu23/",
  twitterUrl: "https://x.com/dummy",
  facebookUrl: "https://x.com/facebook",
  designation: null,
  address: "Delhi, India",
  uniqueName: "sanuatmasai",
  templateId: "2",
  caseStudies: [
    {
      id: 2,
      uid: "178abe5a-95a9-40db-98b4-29bb9703eefd",
      title: "Deploying Dynamic Web Application on AWS",
      overview:
        "The AWS Deployment of a Dynamic Web Application project demonstrates the ability to deploy a full-stack dynamic application (Todo-app) on Amazon Web Services (AWS), leveraging various cloud services to ensure scalability, reliability, and efficiency.\n\nDuring the course of this project,",
      startTime: "2025-04-24",
      endTime: "2025-05-04",
      toolsUsed: ["AWS", "CI/CD", "Cloud Computing", "Docker"],
      outcomes: [
        "Set up and configured various AWS services.",
        "Implemented deployment strategies for both front-end and back-end applications.",
        "Ensured secure and efficient data management using RDS and IAM.",
        "Tested the deployed application to verify its functionality.",
      ],
      mediaUrls: [
        "https://ecomm-dev-public.s3.ap-south-1.amazonaws.com/uploads/Screenshot%202025-02-05%20165842.png",
        "https://ecomm-dev-public.s3.ap-south-1.amazonaws.com/uploads/Screenshot%202025-02-08%20212452.png",
        "https://ecomm-dev-public.s3.ap-south-1.amazonaws.com/uploads/Screenshot%202025-02-09%20125339.png",
      ],
      youTubeUrl:
        "https://www.youtube.com/watch?v=k1RI5locZE4&list=PL9ooVrP1hQOFWxRJcGdCot7AgJu29SVV3",
      themeId: "2",
      totalViews: 0,
      uniqueViews: 0,
      createdUserId: 2,
    ...
    {
      id: 3,
      uid: "eacf39e2-1b18-4d21-a011-57609d688e38",
      title: "Order Management System",
      overview:
        "The Order Management System (OMS)  is designed to facilitate the smooth handling of orders, ensuring precise inventory management and timely fulfillment. This system allows sellers to manage their inventory, and customers to place and manage their orders efficiently.",
      startTime: "2025-04-29",
      endTime: "2025-05-04",
      toolsUsed: [
        "Multi Threading",
        "Design Patterns",
      ...
      outcomes: [
        ...
        "Made use of OOP concepts, SOLID principles, and Design patterns to ensure the extensibility of the application.",
        "Ensured Concurrent requests are handled well using Multithreading.",
      ],
      mediaUrls: [
        "https://ecomm-dev-public.s3.ap-south-1.amazonaws.com/uploads/Screenshot%202025-02-02%20075252.png",
        "https://ecomm-dev-public.s3.ap-south-1.amazonaws.com/uploads/Screenshot%202025-02-05%20173137.png",
      ],
      youTubeUrl: "https://www.youtube.com/watch?v=yxf2spbpTSw",
      themeId: "2",
      totalViews: 1,
      uniqueViews: 1,
      createdUserId: 2,
...
export function MinimalTemplate({ data = sampleData, template }) {
...
export function ModernTemplate({ data = sampleData, template }) {
              ...
              >
                ...
                <div className="flex-1 group relative">
                  ...
                  <div className="relative rounded-lg overflow-hidden shadow-2xl">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                    ></div>
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <button
                    onClick={() =>
                      navigate(template ? study.uid : "case", { state: study })
                    }
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-slate-400">
              {data?.designation || "Professional Portfolio"}
            </p>
          </div>
...
export function MinimalistTemplate({ data = sampleData, template }) {
  const navigate = useNavigate();
    ...
    <div className="max-w-4xl mx-auto p-8 space-y-16">
      ...
      <div className="space-y-6 text-center">
        <h1 className="text-6xl font-light tracking-tight">
          {profileData?.displayName ?? profileData?.user?.displayName}
        </h1>
        <div className="w-16 h-1 bg-gray-800 mx-auto" />
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          {profileData?.bio ?? profileData?.user?.bio}
        </p>
